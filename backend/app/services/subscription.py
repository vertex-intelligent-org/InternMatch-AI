...
PRO_EMPLOYER_ENTITLEMENT_ID = "pro_employer"
...
def get_employer_subscription_snapshot(
    db: Session,
    *,
    user_id: UUID,
) -> dict[str, Any]:
    """Return backend-authoritative Employer Free/Pro subscription state."""
    ...
    return {
        "plan": "employer_pro" if active else "free",
        "entitlement_id": entitlement.entitlement_id,
        "is_active": active,
        "status": status,
        "will_renew": bool(entitlement.will_renew) if active else False,
